...
class DeterministicMockModel:
    def __init__(self, rankings=None):
        self.rankings = (
            rankings
            if rankings
            else [0.1, 0.33, 0.332, 0.4, 0.9, 0.87, 0.31, 0.123, 0.56, 0.04]
        )
...
class TestCheckupUser:
    ...
    test_user_comments = [
        "Hey, this is a first comment on Reddit!",
    ...
    def test_checkup_user(self):
        percentage_insulting, insults, worst = Insults.checkup_user(
            self.test_user_comments
        )

        assert percentage_insulting == 2 / 7.0
        assert (
            self.test_user_comments[2] in insults
            and self.test_user_comments[3] in insults
        )
...
class TestWorstComments:
    ...
    test_comments = [
        "This is a good comment. I love you.",
...
class TestFoulLanguage:
    def test_foul_language_with_context(self):
        test_strings = [
            "I think you're a fucking terrible person. I won't apologise for it.",
        ...
        assert_equal(
            context,
            ["I think you're a fucking terrible person.", "Shit, this is the greatest"],
        )
    ...
    def test_foul_language_clean_comment(self):
        test_string = (
            """This is a perfectly pleasant comment. It's about sunshine and flowers."""
        )
    ...
    def test_foul_language_quoted_swear_words(self):
        test_string = (
            """You said "fuck off" to me, and I though that was unacceptable."""
        )
