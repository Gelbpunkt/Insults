from insults.models.nn_model.util import strip_html, LossHistory
...
class TestLossHistory:
    ...
    def test_on_batch_end(self):
        test_logs = {"loss": [1, 2, 3, 4, 5], "acc": [1, 2, 3, 4, 5]}
        ...
        test_logs_second_batch = {"loss": [5, 4, 3, 2, 1], "acc": [5, 4, 3, 2, 1]}
